...
ros2 run newton_raphson_px4 run_node --platform hw --trajectory fig8_contraction --double-speed --log
ros2 run newton_raphson_px4 run_node --platform hw --trajectory fig8_contraction --double-speed --ff --log
```
...
ros2 run newton_raphson_px4 run_node --platform hw --trajectory fig8_contraction --double-speed --pyjoules --log
ros2 run newton_raphson_px4 run_node --platform hw --trajectory fig8_contraction --double-speed --ff --pyjoules --log
```
