...
ros2 run newton_raphson_px4 run_node --platform hw --trajectory fig8_akash --double-speed --log
ros2 run newton_raphson_px4 run_node --platform hw --trajectory fig8_akash --double-speed --ff --log
```
...
ros2 run newton_raphson_px4 run_node --platform hw --trajectory fig8_akash --double-speed --pyjoules --log
ros2 run newton_raphson_px4 run_node --platform hw --trajectory fig8_akash --double-speed --ff --pyjoules --log
```
